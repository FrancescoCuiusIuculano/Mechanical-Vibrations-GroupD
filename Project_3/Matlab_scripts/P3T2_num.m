...
yInit = [Vs(9,mode); Vs(2,mode);  Vs(8,mode); Vs(1,mode);  Vs(10,mode); Vs(3,mode);  Vs(11,mode);
         Vs(4,mode); Vs(12,mode); Vs(5,mode); Vs(13,mode); Vs(6,mode);  Vs(14,mode); Vs(7,mode)]; % Initial conditions
...
for tt = 1:points/10:length(interval)
    ...
    plot(x,w*1e3,'color',colors(cc),'Linewidth',1.5);
end
